...
export const siteConfig = {
  ...
  seo: {
    ...
    defaultDescription:
      'Professional PC repair in Harold Hill, Romford. Expert laptop repairs, virus removal & data recovery. Call 07971 331814.',
    defaultKeywords:
      'computer repair harold hill, computer repair romford, pc repair near me, laptop repair essex',
  },
} as const;
